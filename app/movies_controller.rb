...
def can_get_the_first_item_in_the_database
  first_item = Movie.first
  first_item.title
end

def can_get_the_last_item_in_the_database
  last_item = Movie.last
  last_item.title
end
...
def can_find_by_multiple_attributes
  ...
  # release_date == 2000
  # director == "Me"
  answer = Movie.find_by(title: "Title", release_date: 2000, director: "Me")
end

def can_find_using_where_clause_and_be_sorted
  # For this test return all movies released after 2002 and ordered by
  # release date descending
  answer = Movie.where("release_date > 2002").order(release_date: :desc)
end
...
def can_destroy_a_single_item
  ...
  kill_movie = Movie.find_by(title: "That One Where the Guy Kicks Another Guy Once")
  kill_movie.destroy
end
